...
2. Compares `version` / `build` to local `APP_VERSION` (`1.4.0` / `140` in `www/js/nest-v13.js`).
...
1. Install user APK `1.4.0`.
2. Confirm Settings shows `v1.4.0`.
3. Temporarily raise remote `app-version.json` to `1.4.0` and upload `/bundles/v1.4.0/`.
